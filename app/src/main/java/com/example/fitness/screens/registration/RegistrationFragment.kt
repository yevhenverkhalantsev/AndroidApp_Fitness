package com.example.fitness.screens.registration
...
import com.example.fitness.screens.registration.viewmodel.OnExceptionHandler
...
class RegistrationFragment:  DaggerFragment(), OnExceptionHandler {
    ...
    private fun initListeners() {
        ...
        binding.registerButton.setOnClickListener {
            if (isPhoneNumberCorrect()) registrationUser()
        }
    }
